...
export const ACT_DEFS = {
  ...
  blurting: {
    ...
    goal: "Open the Blurting tool, write everything you know from memory, then review what you missed",
  },
  questions: {
    icon: "❓",
    ...
    goal: "Attempt all questions without looking at notes, then review mark schemes for missed points",
  },
  notes: {
    icon: "📝",
